/*
    GrammarToDotStringVisitorColored.h
...
#ifndef GrammarToDotStringVisitorColored_H_
#define GrammarToDotStringVisitorColored_H_
...
class GrammarToDotStringVisitorColored : public GrammarVisitor {
    public:   
        GrammarToDotStringVisitorColored();
        ~GrammarToDotStringVisitorColored() {}
    ...
    private:
        ...
        //std::vector<std::string> nodeColor;     //this string is for the clustering sections, it will be added to mStr 
        std::string nodeColor[100];
        int cluster =0;
        int color = 0;
        int i = 0;
